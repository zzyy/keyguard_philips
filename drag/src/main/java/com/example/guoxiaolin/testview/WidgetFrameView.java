...
public class WidgetFrameView extends ViewGroup
{
    private int mScreenHeight;
    private static final String TAG = "WidgetFrameView";

    public WidgetFrameView(Context context, AttributeSet attrs, int defStyle)
    {
        super(context, attrs, defStyle);
    }

    public WidgetFrameView(Context context)
    {

        super(context);
    }

    public WidgetFrameView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
